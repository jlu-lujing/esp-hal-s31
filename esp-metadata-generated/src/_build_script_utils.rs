        ...
        match self {
            Self::Esp32 => Config {
                ...
                symbols: &[
                    ...
                    "i2s_pdm_max_tx_lines=\"1\"",
                    "i2s_pdm_max_tx_lines_is_set",
                    "i2s_pdm_max_rx_lines=\"1\"",
                    "i2s_pdm_max_rx_lines_is_set",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines=\"1\"",
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines_is_set",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines=\"1\"",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines_is_set",
            ...
            Self::Esp32c3 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=i2s_supports_pdm_rx",
                    "cargo:rustc-cfg=i2s_supports_pcm2pdm",
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines=\"2\"",
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines_is_set",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines=\"1\"",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines_is_set",
                    "cargo:rustc-cfg=interrupts_status_registers=\"2\"",
            ...
            Self::Esp32p4 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines=\"2\"",
                    "cargo:rustc-cfg=i2s_pdm_max_tx_lines_is_set",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines=\"4\"",
                    "cargo:rustc-cfg=i2s_pdm_max_rx_lines_is_set",
            ...
            Self::Esp32s31 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_uart1",
                    "cargo:rustc-cfg=soc_has_uhci0",
                    "cargo:rustc-cfg=soc_has_usb_serial_jtag",
                    "cargo:rustc-cfg=soc_has_lp_clkrst",
                    "cargo:rustc-cfg=soc_has_lp_i2c",
                    "cargo:rustc-cfg=soc_has_lp_uart",
                    "cargo:rustc-cfg=soc_has_rtc_cntl",
                    "cargo:rustc-cfg=soc_has_bt",
                    "cargo:rustc-cfg=soc_has_gpio_dedicated",
                ...
                memory_layout: &MemoryLayout {
                    regions: &[(
                        "dram",
                        MemoryRegion {
                            address_range: 0x2F000000..0x2F0A0000,
                        },
                    )],
                },
                pins: &[
...
pub fn emit_check_cfg_directives() {
    ...
    println!("cargo:rustc-check-cfg=cfg(i2s_pdm_max_tx_lines_is_set)");
    println!("cargo:rustc-check-cfg=cfg(i2s_pdm_max_rx_lines_is_set)");
    ...
    println!("cargo:rustc-check-cfg=cfg(soc_has_ledc0)");
    println!("cargo:rustc-check-cfg=cfg(soc_has_sdmmc)");
    println!("cargo:rustc-check-cfg=cfg(soc_has_usb_serial_jtag)");
    println!("cargo:rustc-check-cfg=cfg(soc_has_lp_i2c)");
    ...
    println!("cargo:rustc-check-cfg=cfg(i2s_pdm_max_rx_lines, values(\"1\",\"4\"))");
    println!(
